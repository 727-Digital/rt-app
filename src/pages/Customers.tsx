...
const CUSTOMER_STATUSES: LeadStatus[] = [
  'quote_approved',
  'deposit_paid',
  'install_scheduled',
  'install_complete',
...
function compareLead(a: Lead, b: Lead, field: SortField, dir: SortDir): number {
  ...
  switch (field) {
    ...
    case 'estimate_min':
      ...
      break;
    case 'status':
      cmp = CUSTOMER_STATUSES.indexOf(a.status) - CUSTOMER_STATUSES.indexOf(b.status);
      break;
    case 'created_at':
...
export default function Customers() {
  ...
  const filtered = useMemo(() => {
    let result = leads.filter((l) => CUSTOMER_STATUSES.includes(l.status));
          ...
          <EmptyState
            ...
            description={
              search || statusFilter !== 'all'
                ...
                : 'Leads become customers once their quote is approved.'
            }
          />
        ) : (
          <>
